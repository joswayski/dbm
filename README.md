...
- [Native development clients](docs/native.md): shared Rust core, macOS AppKit and Windows/Linux egui workbenches; parity is in progress and downloads above still use Tauri
